...
const ArticlesPublics = () => {
    ...
    const tabsItems = [
        ...
        { label: "terminés", size: encheres?.filter(enchere => !enchere?.trash && enchere?.enchere_type === "public" && ExpirationVerify(enchere?.expiration_time)).length || 0 },
    ...
    useEffect(() => {
        switch (activeTab) {
            ...
            case "publier": setData(encheres?.filter(enchere => !enchere?.trash && enchere?.enchere_status === "published" && enchere?.enchere_type === "public" && !ExpirationVerify(enchere?.expiration_time))); break;
            case "attente": setData(encheres?.filter(enchere => !enchere?.trash && enchere?.enchere_status === "pending" && enchere?.enchere_type === "public" && !ExpirationVerify(enchere?.expiration_time))); break;
            case "rejetés": setData(encheres?.filter(enchere => !enchere?.trash && enchere?.enchere_status === "rejected" && enchere?.enchere_type === "public" && !ExpirationVerify(enchere?.expiration_time))); break;
            case "terminés": setData(encheres?.filter(enchere => !enchere?.trash && enchere?.enchere_type === "public" && ExpirationVerify(enchere?.expiration_time))); break;
            case "corbeille": setData(encheres?.filter(enchere => enchere?.trash && enchere?.enchere_type === "public")); break;
            default: setData(encheres?.filter(enchere => !enchere?.trash && enchere?.enchere_status === "published" && enchere?.enchere_type === "public" && !ExpirationVerify(enchere?.expiration_time))); break;
        }
    }, [encheres, activeTab]);
