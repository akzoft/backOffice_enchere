...
import { auth, checking, deleteUser, getUsers, login, register, updateUser } from "./redux/actions/user";
...
export {
    ...
    update_enchere_actions, register, validation_create_client, inputSeparator, separatorhandleChange, inputSeparatorMille
}