...
import { ExpirationVerify, formatNumberWithSpaces, handleChange, isEmpty, setPath } from "./js/fonctions";
import { validation_create_enchere } from "./js/validation";
